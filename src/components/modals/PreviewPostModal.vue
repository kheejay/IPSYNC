<template>
    <div class="z-[2] w-screen h-screen fixed top-0 left-0 flex items-center justify-center px-[1rem] overflow-y-auto pt-[12rem] pb-[6rem] sm:pt-0 sm:pb-0 select-text">
        ...
        <div class="z-[3] drop-shadow max-w-[55rem] w-[55rem] min-h-[38rem] bg-white rounded-[2.4rem] relative p-[1.25rem]">
            <img src="/src/assets/images/ProjectsBg.svg" alt="projectBg" 
                class="absolute bottom-[0.943rem] -left-[1.08rem] w-[25rem] h-auto rounded-[2.4rem] rotate-90 select-none">
            <img src="/src/assets/images/ProjectsBg.svg" alt="projectBg" 
                class="absolute top-[0.98rem] -right-[1.08rem] w-[25rem] h-auto rounded-[2.4rem] -rotate-[90deg] select-none">
            ...
            <div class="flex flex-col w-full pl-[0.75rem] sm:pl-[1.5rem] relative">
